...
- [What's probability of one birthday shared by two persons in any size of room?](https://changyuchang.name/post/generalized-birthday-problem/#what's-probability-of-one-birthday-shared-by-two-persons-in-any-size-of-room?)

- [Binary search](https://changyuchang.name/post/generalized-birthday-problem/#binary-search)

- [Replicate size](https://changyuchang.name/post/generalized-birthday-problem/#replicate-size)
