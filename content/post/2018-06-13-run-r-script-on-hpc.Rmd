...
- [Run R on HPC](https://www.changyuchang.name/post/run-r-script-on-hpc/#run-r-on-hpc)
    + [Load R from module](https://www.changyuchang.name/post/run-r-script-on-hpc/#load-r-from-module)
    + [Install package](https://www.changyuchang.name/post/run-r-script-on-hpc/#install-package)
    + [Run R script with arguments in command line](https://www.changyuchang.name/post/run-r-script-on-hpc/#run-r-script-with-arguments-in-command-line)

- [Run R in batch mode](https://www.changyuchang.name/post/run-r-script-on-hpc/#run-r-in-batch-mode)
    + [Node, core, and other jargons](https://www.changyuchang.name/post/run-r-script-on-hpc/#node- core-and-other-jargons)
    + [Submit the batch job](https://www.changyuchang.name/post/run-r-script-on-hpc/#submit-the-batch-job)
    + [Pipeline](https://www.changyuchang.name/post/run-r-script-on-hpc/#pipeline)
