...
b 
```
Bascially, `benchmark` runs each methods for 1000 times, and compare the time consumed. It takes 10.514/1000 = 0.010514 seconds for running `simulateC(k=2, room=23, replicate=1e4)` once and 0.060131 seconds for running the `tabulate` method once. So on average, the `Rcpp` method is 5.7 times faster than `tabulate` metods. 
