...
b 
```
Bascially, `benchmark` runs each methods for 1000 times, and compare the time consumed. It takes 9.278/1000 = 0.009278 seconds for a run of `simulateC(k=2, room=23, replicate=1e4)` and 0.05239 seconds for a run of `tabulate` method. So on average, the `Rcpp` method is 5.647 times faster than `tabulate` metods. 
