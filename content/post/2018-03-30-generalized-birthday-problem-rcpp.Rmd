...
- [Generalized birthday problem](https://changyuchang.netlify.com/post/generalized-birthday-problem-rcpp/#generalized-birthday-problem)
...
With better accurary (a million replicates), the ideal room size for *k=8* is 798.
```{r}
y_rcpp
```
